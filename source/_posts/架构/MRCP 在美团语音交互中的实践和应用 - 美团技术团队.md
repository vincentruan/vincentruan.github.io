---
title: "MRCP 在美团语音交互中的实践和应用 - 美团技术团队"
date: 2025-08-28 09:40:06
categories: 架构
tags:
description: "本文详细介绍了美团如何基于MRCP协议建设标准化的语音合成和识别服务。MRCP作为媒体资源控制协议，为语音服务提供了统一的接口标准，使业务方能一次开发、多处应用。文章从MRCP协议原理、系统架构设计、关键技术组件选型（UniMRCP、Kamailio）、部署方案（跨地域多机房、负载均衡）到实际应用效果进行了全面阐述，展示了MRCP在降低首包延时、提升用户体验方面的显著成效。"
---
...
![](https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/edbf78eced065ebe989855d0d558991ed3ce8680.jpg)
...
![](https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/83aa46db125533ada7909c123419bc4279988d43.jpg)
...
![](https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/afccb083758766d0c4d466a4cbe78d63d59a611a.jpg)
...
![](https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/acf2eb2b5ba16b4a84dd43ca27d8c4ce24aa247e.jpg)

图 4 MRCP 在 AICC 层次架构中的位置关系

#### 2.2.2 系统间调用关系

以热线电话机器人的系统调用过程为例，MRCP 在系统中所处的位置以及同其他各环节的配合关系如下图 5 所示：

![](https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/b7ea8bda5b6ad4dec163211b577ca5c9090b4c6d.jpg)

图 5 MRCP 服务调用关系

1.  FreeSWITCH 电话软交换平台，负责和运营商打通通讯线路，以具备基础的电话通讯能力。
2.  FreeSWITCH 除了以内置模块（如 mod_java）的方式开发控制接口外，也以 ESL（Event Socket Library）的 Inbound/Outbound 方式开放接口，提供事件监听、通话控制等能力。
...
对于实现 MRCP-Server 的负载均衡，我们选用开源的 [Kamailio](https://www.kamailio.org/w/) 来完成。Kamailio 的前身叫 Openser，作为出色的 SIP proxy，在大并发量使用时常常用于负载均衡媒体服务器，对 Asterisk、FreeSWITCH、MRCP 等实现集群能力 [5]。Kamailio 经常与 FreeSWITCH 配合使用，最常用的场景是 Kamailio 作呼叫负载均衡服务器（一般主备配置），FreeSWITCH 做媒体相关的处理如转码、放音、录音、呼叫排队等。
...
![](https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/b86c66ac1610a8eb3748afa022566fddfe18d042.jpg)
...
![](https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/61839231e21389bc2597321a0fdf3f69d2004f7a.jpg)
...
| 升级前：
<audio controls src="https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/20260302-卡顿01-1772439982853.mp3"></audio>

| 升级后：
<audio controls src="https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/20260302-卡顿01优化-1772439980060.mp3"></audio>

**机械优化**

>::: block-1 播报文案为：“非常抱歉，查询到您的订单收货已超过 48 小时，由于生鲜商品容易腐烂，因此暂不支持超 48 小时的售后退款，下次遇到问题还请您尽早反馈，给您带来的不便我们深感抱歉。” :::

| 升级前：
<audio controls src="https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/20260302-机械-1772439788877.mp3"></audio>

| 升级后：
<audio controls src="https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/20260302-机械优化-1772439970172.mp3"></audio>
...
| 升级前：
<audio controls src="https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/20260302-延时过高示例-1772439976319.mp3"></audio>

| 升级后：
<audio controls src="https://raw.githubusercontent.com/vincentruan/picgo/main/piclist/20260302-延时优化-1772439973287.mp3"></audio>
...
|名词|解释|
|---|---|
|RTP|RTP（Real-Time Transport Protocol）实时传输协议，适用于传输实时数据的应用程序，如音频、视频或模拟数据，可通过 RTP 的子协议 RTCP（RTP Control Protocol）保证服务质量。在 MRCP 中负责对媒体资源进行传输。|
...
*   [1] Media Resource Control Protocol (2022) Wikipedia. Wikimedia Foundation. Available at: [https://en.wikipedia.org/wiki/Media_Resource_Control_Protocol](https://en.wikipedia.org/wiki/Media_Resource_Control_Protocol).
*   [2] 史俊波, 詹舒波 (2010) MRCPv2 协议及其在分布式语音资源解决方案中的应用, 中国科技论文在线 - 科技论文. Available at: [http://www.paper.edu.cn/releasepaper/content/201009-322](http://www.paper.edu.cn/releasepaper/content/201009-322)
*   [3] zhu, james (2018) MRCP 概要, CTI. Available at: [http://www.ctiforum.com/news/guonei/534456.html](http://www.ctiforum.com/news/guonei/534456.html).
