...
![img](824587-20161210013029741-1131403264.png)**此时需要用到三台服务器，一台nginx服务器，两台正式部署项目的服务器：选择的是192.168.50.133主nginx和192.168.50.137,192.168.50.139两台tomcat服务器**
...
![img](824587-20161208231925601-1474979822.png)

编辑好后 service iptables restart 重新加载防火墙配置

![img](824587-20161208232235554-821786257.png)
...
![img](824587-20161210021128741-783517177.png)**将项目中web.xml中的访问顺序index.jsp上移到第一个访问**

 

**然后右键导出为war包，testproject.war，将该war包上传到两台服务器的tomcat的webapps中**

![img](824587-20161210021748835-63821191.png)
...
![img](824587-20161208233450960-1697266825.png)
...
![img](824587-20161208233822866-868810441.png)
...
![img](824587-20161208234258757-1246458568.png)
...
![img](824587-20161210040326319-1999583685.png)
...
![img](824587-20161209013336616-1475474059.png)

 

本例中：

![img](824587-20161210032226226-287390560.png)
...
![img](824587-20161210035234491-2112324971.png)
...
![img](824587-20161210035545319-539003657.png)
...
![img](824587-20161209011942835-1106019887.png)
...
![img](824587-20161209012259272-825047638.png)
...
![img](824587-20161210041217944-704715113.png)

 修改content.xml

![img](824587-20161210041412757-1950717785.png)
...
**![img](824587-20161210053320116-1854584241.png)**
...
![img](824587-20161210133227866-1513518612.png)
...
![img](824587-20161210141242882-701187483.png)

 浏览器访问虚拟ip：192.168.50.88，效果如下

 ![img](824587-20161210141512835-1512216780.png)

 

 **备机：ip addr命令执行：可以看到，备机nginx没有绑定虚拟ip**

![img](824587-20161210141645413-2057533357.png)
...
```
 ...
 ![img](824587-20161210151054194-750610516.png)
...
![img](824587-20161210164416866-1695444383.png)

然后执行脚本：

主机脚本检测nginx不在了，把keepalived停掉，从输出可以看到确实停止了，主机虚拟没有绑定虚拟ip

![img](824587-20161210164620554-1932400026.png)

备机：成功绑定虚拟ip

 ![img](824587-20161210164655538-1777482179.png)
...
![img](824587-20161210172645757-50735121.png)

 

 备机：绑定虚拟ip，切换成功。

 ![img](824587-20161210172826429-550094922.png)
