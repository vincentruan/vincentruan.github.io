...
![img](从ReentrantLock的实现看AQS的原理及应用/412d294ff5535bbcddc0d979b2a339e6102264.png)
...
通过上文我们已经了解，ReentrantLock支持公平锁和非公平锁（关于公平锁和非公平锁的原理分析，可参考《[不可不说的Java“锁”事](https://tech.meituan.com/2018/11/15/java-lock.html)》），并且ReentrantLock的底层就是由AQS来实现的。那么ReentrantLock是如何通过公平锁和非公平锁与AQS关联起来呢？ 我们着重从这两者的加锁过程来理解一下它们与AQS之间的关系（加锁过程中与AQS的关联比较明显，解锁流程后续会介绍）。
...
![img](从ReentrantLock的实现看AQS的原理及应用/82077ccf14127a87b77cefd1ccf562d3253591.png)
...
![img](从ReentrantLock的实现看AQS的原理及应用/d2f7f7fffdc30d85d17b44266c3ab05323338.png)
...
![img](从ReentrantLock的实现看AQS的原理及应用/7132e4cef44c26f62835b197b239147b18062.png)
...
![img](从ReentrantLock的实现看AQS的原理及应用/960271cf2b5c8a185eed23e98b72c75538637.png)
...
![img](从ReentrantLock的实现看AQS的原理及应用/27605d483e8935da683a93be015713f331378.png)![img](从ReentrantLock的实现看AQS的原理及应用/3f1e1a44f5b7d77000ba4f9476189b2e32806.png)
...
![img](从ReentrantLock的实现看AQS的原理及应用/b8b53a70984668bc68653efe9531573e78636.png)

为了帮助大家理解ReentrantLock和AQS之间方法的交互过程，以非公平锁为例，我们将加锁和解锁的交互流程单独拎出来强调一下，以便于对后续内容的理解。

![img](从ReentrantLock的实现看AQS的原理及应用/7aadb272069d871bdee8bf3a218eed8136919.png)
...
![img](从ReentrantLock的实现看AQS的原理及应用/f30c631c8ebbf820d3e8fcb6eee3c0ef18748.png)
...
![img](从ReentrantLock的实现看AQS的原理及应用/e9e385c3c68f62c67c8d62ab0adb613921117.png)
...
![img](从ReentrantLock的实现看AQS的原理及应用/c124b76dcbefb9bdc778458064703d1135485.png)

从上图可以看出，跳出当前循环的条件是当“前置节点是头结点，且当前线程获取锁成功”。为了防止因死循环导致CPU资源被浪费，我们会判断前置节点的状态来决定是否要将当前线程挂起，具体挂起流程用流程图表示如下（shouldParkAfterFailedAcquire流程）：

![img](从ReentrantLock的实现看AQS的原理及应用/9af16e2481ad85f38ca322a225ae737535740.png)
...
![img](从ReentrantLock的实现看AQS的原理及应用/b845211ced57561c24f79d56194949e822049.png)

当前节点是Head的后继节点。

![img](从ReentrantLock的实现看AQS的原理及应用/ab89bfec875846e5028a4f8fead32b7117975.png)

当前节点不是Head的后继节点，也不是尾节点。

![img](从ReentrantLock的实现看AQS的原理及应用/45d0d9e4a6897eddadc4397cf53d6cd522452.png)
