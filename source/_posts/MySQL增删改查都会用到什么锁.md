...
![image-20200212152912203](image-20200212152912203.png)
...
![image-20200212162043235](image-20200212162043235.png)
...
![img](640-1581493216096.webp)

  关于这个初始值为何是5，后续的文章中我们会说明。至此，我们已经了解到，一个数据页，大概可以描述成如下形式：

![img](640-1581493216136.webp)
...
![image-20200212160055676](image-20200212160055676.png)
...
![image-20200212155919536](image-20200212155919536.png)
...
![image-20200212155859778](image-20200212155859778.png)
...
![image-20200212155822655](image-20200212155822655.png)
...
![image-20200212155748878](image-20200212155748878.png)

<center>*不可重复读例子*</center>
**幻读（phantom read），**是事务非独立执行时发生的一种现象。

![image-20200212155718409](image-20200212155718409.png)

![image-20200212155728846](image-20200212155728846.png)

<center>*幻读的例子*</center>
在同一时间点，数据库允许多个并发事务，同时对数据进行读写操作，会造成数据不一致性。

![img](640-1581493477920.webp)
...
![image-20200212155627181](image-20200212155627181.png)
