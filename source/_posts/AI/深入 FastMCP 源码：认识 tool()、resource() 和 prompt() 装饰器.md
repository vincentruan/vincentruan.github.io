...
- 资源管理
- MCP&Tools
description: "本文深入解析FastMCP框架中三个核心装饰器的源码实现：@mcp.tool()、@mcp.resource()和@mcp.prompt()。文章从MCP Server和MCP Inspector的启动入手，详细讲解装饰器如何注册工具、资源和提示模板，帮助开发者理解MCP协议的底层机制，不再把装饰器当作黑匣子使用。"
---
...
>
> **代码文件下载**：[server.py](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/blob/master/Demos/mcp/server.py)，[debug_func_metadata.py](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/blob/master/Demos/mcp/debug_func_metadata.py)，[debug_message_validator.py](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/blob/master/Demos/mcp/debug_message_validator.py)
...
![image-20250719193229901](https://raw.githubusercontent.com/Hoper-J/AI-Guide-and-Demos-zh_CN/master/Guide/assets/image-20250719193229901.png)

MCP Inspector 界面配置如下图左框：

![image-20250719175009347](https://raw.githubusercontent.com/Hoper-J/AI-Guide-and-Demos-zh_CN/master/Guide/assets/image-20250719175009347.png)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| ![image-20250725150439850](https://raw.githubusercontent.com/Hoper-J/AI-Guide-and-Demos-zh_CN/master/Guide/assets/image-20250725152300318.png) | ![image-20250719180342191](https://raw.githubusercontent.com/Hoper-J/AI-Guide-and-Demos-zh_CN/master/Guide/assets/image-20250725152524145.png) | ![image-20250719180344573](https://raw.githubusercontent.com/Hoper-J/AI-Guide-and-Demos-zh_CN/master/Guide/assets/image-20250719180344573.png) |

# 什么是 FastMCP？

官方仓库中对应的路径为 [src/mcp/server/fastmcp](https://github.com/modelcontextprotocol/python-sdk/tree/main/src/mcp/server/fastmcp)：

![image-20250719124116252](https://raw.githubusercontent.com/Hoper-J/AI-Guide-and-Demos-zh_CN/master/Guide/assets/image-20250719124116252.png)
...
- 资源可以是静态的（每次调用返回相同内容）或动态的（根据参数填充内容）。
  ...
  - 静态对应于 MCP Inspector 中的 `Resources`，动态对应于 `Resources Templates`，以下面两个资源为例进行展示：
    ...
    ![Resource](https://raw.githubusercontent.com/Hoper-J/AI-Guide-and-Demos-zh_CN/master/Guide/assets/image-20250725151931232.png)
...
>
> **调试文件下载**：[debug_func_metadata.py](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/blob/master/Demos/mcp/debug_func_metadata.py)
...
>
> **调试文件下载**：[debug_message_validator.py](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/blob/master/Demos/mcp/debug_message_validator.py)
